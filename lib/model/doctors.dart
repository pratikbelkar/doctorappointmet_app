import 'package:doctorappointmet_app/model/reviews.dart';
...
List<Doctor> doctors = [
  Doctor(
    ...
    price: 59,
    image:
        "https://cdn3d.iconscout.com/3d/premium/thumb/doctor-3d-icon-download-in-png-blend-fbx-gltf-file-formats--hospital-clinic-man-avatars-pack-people-icons-8772456.png",
    color: 0xFFffcdcf,
  ...
  Doctor(
    ...
    price: 80,
    image:
        "https://cdn3d.iconscout.com/3d/premium/thumb/doctor-avatar-3d-icon-download-in-png-blend-fbx-gltf-file-formats--medical-medicine-profession-pack-people-icons-8179550.png?f=webp",
    color: 0xFFe1edf8,
  ...
  Doctor(
    ...
    price: 80,
    image:
        "https://static.vecteezy.com/system/resources/thumbnails/024/585/358/small_2x/3d-happy-cartoon-doctor-cartoon-doctor-on-transparent-background-generative-ai-png.png",
    color: 0xFFe1edf8,
